<?php
	...
	$mcImageManagerConfig['general.plugins'] = "History,Favorites,MyPlugin"; // comma seperated
	...
	//Ideally the configuration below should be fetched from the symfony yml-files, but I have not found a  way to do so...(Jon)
	$mcImageManagerConfig['preview.wwwroot'] = ''; // absolute or relative from this script path, try to leave blank system figures it out.
	$mcImageManagerConfig['preview.urlprefix'] = ""; // domain name
	//$mcImageManagerConfig['preview.urlprefix'] = '{proto}://{host}/hou'; // domain name
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '/var/www/html/rentallaravel/public/housegraphics/'; // absolute or relative from this script path, required.
	$mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
	$mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
	$mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^mcith$/i|^\.svn';
	...
	// Upload options
	$mcImageManagerConfig['upload.maxsize'] = "100MB";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
	...
	$mcImageManagerConfig['upload.max_height'] = "1600"; // Only if force_width_height is true
	...
	// Authenication
	$mcImageManagerConfig['authenticator'] = "MyPlugin";
