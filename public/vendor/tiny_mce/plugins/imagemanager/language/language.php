...
require_once(__ROOT__."/includes/general.php");
require_once(__ROOT__."/classes/ManagerEngine.php");
require_once(__ROOT__."/classes/Utils/Error.php");
require_once(__ROOT__."/classes/Utils/JSON.php");
