<?php
	...
	$mcFileManagerConfig['general.tools'] = "createdir,createdoc,refresh,zip,upload,edit,rename,cut,copy,paste,delete,selectall,unselectall,view,download,insert,addfavorite,removefavorite";
	...
	// Preview options
	$mcFileManagerConfig['preview.wwwroot'] = '/var/www/html/rentalcommon'; // absolute or relative from this script path (c:/Inetpub/wwwroot).
	...
	$mcFileManagerConfig['filesystem.rootpath'] = '/var/www/html/rentalcommon/housedocuments/'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,ptt,pttx";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,ptt,pttx";
	...
	$mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx,ptt,pttx";
