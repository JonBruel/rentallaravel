<?php
	...
	$mcFileManagerConfig['general.plugins'] = "MyPlugin"; // comma seperated
	...
	// Preview options
	$mcFileManagerConfig['preview.wwwroot'] = '/var/www/html/rentallaravel/public'; // absolute or relative from this script path (c:/Inetpub/wwwroot).
	...
	$mcFileManagerConfig['filesystem.rootpath'] = '/var/www/html/rentallaravel/public/housedocuments/'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.exclude_file_pattern'] = '';
	$mcFileManagerConfig['filesystem.invalid_file_name_msg'] = "";
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,docx";
	...
	$mcFileManagerConfig['upload.extensions'] = "doc,docx,pdf,gif,jpg,png,zip";
	...
	$mcFileManagerConfig['authenticator'] = "MyPlugin";
