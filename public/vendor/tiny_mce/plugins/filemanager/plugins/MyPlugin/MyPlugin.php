 ...
 */
class MyPlugin extends Moxiecode_ManagerPlugin {
    /**
    ...
    function onAuthenticate(&$man) {
        ...
        //TODO: refine this, request does not exist.
        die("Session: ".var_dump($_SERVER));
        if (!$_SESSION['user']) return false;

        $this->user = $_SESSION['user'];
        if ($this->user['customertypeid'] < 100) return true;
        return false;
    }
...
$man->registerPlugin("MyPlugin", new MyPlugin());
