...
class GoogleTranslateWrapper
{
     ...
     *
     *         API key:
     *         AIzaSyC2_s2UrWavQkUXtOkQM8LJN9K_cu8sqH4
     *
     *          IPs:  87.50.216.0/28
     *
     *         Activated on:
     ...
     *
     *         Activated by:
     *         jbr@consiglia.dk – you
     *
     */
    private $_apiKey = 'AIzaSyC2_s2UrWavQkUXtOkQM8LJN9K_cu8sqH4';
     ...
     */
    public function doSanitize($sentence)
    {
        $code = substr($sentence,1,-1);
    ...
    public function translate($text = '', $to, $from = '')
    {
        ...
        if($this->_text != '' && $this->_postFields != '')
        {
            ...
            //die(var_dump($json['data']['translations'][0]['translatedText']));

            //if($json['responseStatus'] == 200)
            if (true)
            {
                $this->_translatedText .= $json['data']['translations'][$this->_currentChunk]['translatedText'];
